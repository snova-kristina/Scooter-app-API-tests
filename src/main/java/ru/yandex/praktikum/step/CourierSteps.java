...
public class CourierSteps {
	...
	public ValidatableResponse createCourier(String login, String password, String firstName) {
		...
		return courierClient.createCourier(createCourierRequest).then().log().all();
	}
